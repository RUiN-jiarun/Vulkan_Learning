...
// Extend our application to allow for multiple frames to be in-flight 
// while still bounding the amount of work that piles up
...
struct QueueFamilyIndices 
{
    ...
    std::optional<uint32_t> graphicsFamily;     // 图像命令子集
    std::optional<uint32_t> presentFamily;      // 呈现命令子集
...
private:
    ...
    // Semaphore signals to control parallel
...
private:
    ...
    /// <summary>
    /// Create swap chian and all of the creation functions for the objects 
    /// that depend on the swap chain or the window size
    /// </summary>
    ...
    void createLogicalDevice() 
    {
        ...
        // Modify VkDeviceCreateInfo to point to a vector
        ...
        // For swapchain requires enabling the VK_KHR_SWAPCHAIN extension
        ...
        // Retrieve the queue handle and get the queues
    ...
    void createSwapChain() 
    {
        ...
        // Filling a structure to create the swap chain object
        ...
        // Drawing on the images in the swap chain from the graphics queue
        QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
    ...
    void createGraphicsPipeline()
    {
        ...
        // Finish constructing the whole render pipeline
    ...
    void createRenderPass()
    {
        ...
        // 9.2 Add subpass dependencies
        // in order to take care of image layout transitions
    ...
    /// We'll use the one that corresponds to the retrieved image at drawing time.
    /// </summary>
    ...
    /// <summary>
    /// Create command pools to manage the memory for buffers and command buffers 
    /// </summary>
    void createCommandPool()
    {
        QueueFamilyIndices queueFamilyIndices = findQueueFamilies(physicalDevice);

        // Each command pool allocates command buffers that are submitted on a single type of queue.
        // Choose the graphics queue family for recording commands for drawing
    ...
    /// <summary>
    /// Allocating command buffers and recording drawing commands
    /// </summary>
    void createCommandBuffers() 
    {
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) 
        {
            ...
            // Setting and starting a render pass
            ...
            // Basic drawing commands binding
    ...
    /// <summary>
    /// Create the fences together with the semphores
    /// </summary>
    ...
    /// 2. Execute the command buffer with the image as attachment in the framebuffer
    ...
    /// <summary>
    /// Shader compile -- A helper function to weap the shader adn pass to the pipeline
    /// </summary>
    ...
    /// <summary>
    /// Querying details of swap chian support
    /// </summary>
    ...
    /// <summary>
    /// Choosing the right settings for the swap chian
    /// </summary>
    /// Surface format
    ...
    // Check if all of the required extensions are among them
