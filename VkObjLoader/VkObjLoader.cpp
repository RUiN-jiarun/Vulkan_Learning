...
private:
    ...
    // 9.10 Load vertices and indices from obj file
    // type of indices will be uint32_t
    std::vector<Vertex> vertices;
    ...
    void createGraphicsPipeline()
    {
        ...
        //rasterizer.cullMode = VK_CULL_MODE_BACK_BIT;    // In this mode the back face will be culled
    ...
    /// <summary>
    /// Load the obj file
    /// Including positions, normals, texture coordinates and faces
    /// </summary>
    void loadModel()
    {
